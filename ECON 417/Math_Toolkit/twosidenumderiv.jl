...
# calculates the two-sided numerical derivative using the definition in the notes provided by Professor Smith
...
# establishes the function defined in the problem set
function f(x)
