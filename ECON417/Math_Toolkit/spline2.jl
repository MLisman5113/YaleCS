...
writearrays(stdout,(5,(3,15.8)),yspline.x,yspline.y,yspline.ydp) # gridpoints, values, second derivatives
...
while doloop
   ...
   writeio(stdout,((7,15.8),),xval,yval,f(xval),yvalp,fp(xval),yvaldp,fdp(xval)) # level, 1st derivative, 2nd derivative
end   
